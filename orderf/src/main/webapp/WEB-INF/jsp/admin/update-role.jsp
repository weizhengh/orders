  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4" style="margin-left: 500px">
        <form id="addemp" class="am-form am-form-horizontal" action="<%=basePath%>role/updateRole.action" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名</label>
            <div class="am-u-sm-9">
            <input type="hidden" name="role_id" value="${role.role_id}" id="user-name" >
              <input type="text" name="role_name" value="${role.role_name}" id="user-name" placeholder="角色名称  ">
            </div>
          </div>
