...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">菜品添加</strong> / <small>form</small></div>
  </div>

  <div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-tabs-nav am-nav am-nav-tabs">
      <li><a href="#tab3">菜品信息添加</a></li>
    </ul>

    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade" id="tab3">
        <form class="am-form" action="addFood.action" method="post" enctype="multipart/form-data" onsubmit="return checkForm();">
          <div class="am-g am-margin-top-sm">
            <div class="am-u-sm-2 am-text-right">
              菜品名称
            </div>
            <div class="am-u-sm-4 am-u-end">
              <input type="text" class="am-input-sm" name="food_name" value="" maxlength="10" id="food_name" onblur="checkFoodname()"/>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input type="text" class="am-input-sm" name=food_pirce value="" maxlength="10" id="fprice"
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <textarea rows="4" name="food_note" maxlength="30" id="fnote"></textarea>
            </div>
          </div>
