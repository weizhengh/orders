       ...
       <div class="am-cf">
			  ...
			  <div class="am-fr">
			    <ul class="am-pagination">
			      <li><a href="${pageContext.request.contextPath}/selectByfoodId.action?pn=1&food_soft_id=${food_soft_id}">首页</a></li>
			      <c:if test="${pageInfo.hasPreviousPage}">
			      	<li><a href="${pageContext.request.contextPath}/selectByfoodId.action?pn=${pageInfo.pageNum-1}&food_soft_id=${food_soft_id}">«</a></li>
			      </c:if>
			      <!--循环遍历连续显示的页面，若是当前页就高亮显示，并且没有链接-->
                    <c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
                        ...
                        <c:if test="${page_num != pageInfo.pageNum}">
                            <li><a href="${pageContext.request.contextPath}/selectByfoodId.action?pn=${page_num}&food_soft_id=${food_soft_id}">${page_num}</a></li>
                        </c:if>
                    </c:forEach>
                    <c:if test="${pageInfo.hasNextPage}">
			      		<li><a href="${pageContext.request.contextPath}/selectByfoodId.action?pn=${pageInfo.pageNum+1}&food_soft_id=${food_soft_id}">»</a></li>
			      	</c:if>
			      	<li><a href="${pageContext.request.contextPath}/selectByfoodId.action?pn=${pageInfo.pages}&food_soft_id=${food_soft_id}">尾页</a></li>
			    </ul>
			  </div>
			</div>
          <hr />
