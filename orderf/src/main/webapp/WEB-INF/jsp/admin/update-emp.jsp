  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4" style="margin-left: 500px">
        <form id="addemp" class="am-form am-form-horizontal" action="<%=basePath%>emp/updateEmp.action" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名</label>
            <div class="am-u-sm-9">
            <input type="hidden" name="emp_id" value="${empInfo.emp_id}" id="user-name" >
              <input type="text" name="emp_name" value="${empInfo.emp_name}" id="user-name" placeholder="姓名 ">
            </div>
          </div>
          
          <div class="am-form-group">
            <label for="user-phone" class="am-u-sm-3 am-form-label">账号</label>
            <div class="am-u-sm-9">
              <input type="text" name="emp_login" value="${empInfo.emp_login}" id="user-phone" placeholder="账号 ">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="password" name="emp_password" value="${empInfo.emp_password}" id="user-QQ" placeholder="密码">
            </div>
          </div>

          <div class="am-form-group">
            <label for="user-weibo" class="am-u-sm-3 am-form-label">工资</label>
            <div class="am-u-sm-9">
              <input type="text" name="emp_salary" value="${empInfo.emp_salary}" id="user-weibo" placeholder="工资">
            </div>
          </div>
