...
<!-- 移动设备支持 -->
    ...
    <link href="<%=basePath%>css/mall.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="<%=basePath%>js/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>js/jquery.Spinner.js"></script>
...
<div class="mall_main">
	...
	<div id="banner_box" class="box_swipe">
		<ul>
			<li><img src="<%=basePath%>img/1.jpg"></li>
			<li><img src="<%=basePath%>img/2.jpg"></li>
			<li><img src="<%=basePath%>img/3.jpg"></li>
			<li><img src="<%=basePath%>img/4.jpg"></li>
		</ul>
		<ol>
			<li class="on"></li>&nbsp;
			<li></li>&nbsp;
    ...
    <div class="box_list">
        ...
        <div class="goods_box">
            <img src="<%=basePath%>img/1.jpg" width="100%">
			<img src="<%=basePath%>img/2.jpg" width="100%">
			<img src="<%=basePath%>img/3.jpg" width="100%">
			<img src="<%=basePath%>img/4.jpg" width="100%">
        </div>
...
<script src="<%=basePath%>js/swipe2.js" type="text/javascript"></script>
