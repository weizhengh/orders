        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <button type="button"  class="am-btn am-btn-default"><a href="<%=basePath%>role/findPower.action?roleId=${roleId}" class="am-icon-plus">添加权限</a></button>
        ...
        <form class="am-form">
          ...
          <c:forEach items="${menu}" var="m">
            <tr>
              ...
              <td>${m.power.power_name}</td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a  class="am-btn am-btn-default am-btn-xs am-text-danger" href="<%=basePath%>role/delMenu.action?menuId=${m.menu_id}">
                    <span class="am-icon-trash-o"></span>移除</a>
                  </div>
                </div>
              </td>
            </tr>
