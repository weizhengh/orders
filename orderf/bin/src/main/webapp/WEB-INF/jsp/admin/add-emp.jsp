  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4" style="margin-left: 500px">
        <form id="addemp" class="am-form am-form-horizontal" action="<%=basePath%>emp/addEmp.action" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名</label>
            <div class="am-u-sm-9">
              <input type="text" name="emp_name" id="user-name" placeholder="姓名 ">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="emp_login" id="user-phone" placeholder="账号 ">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="password" name="emp_password" id="user-QQ" placeholder="密码">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="emp_salary" id="user-weibo" placeholder="工资">
            </div>
          </div>

          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button id="submit" type="submit" class="am-btn am-btn-primary">添加</button>
            </div>
          </div>
        </form>
      </div>
