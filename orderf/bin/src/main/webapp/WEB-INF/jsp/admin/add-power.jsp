      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4" style="margin-left: 500px">
        <form id="addemp" class="am-form am-form-horizontal" action="<%=basePath%>customer/addCustomer.action" method="post">
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="power_name" id="user-name" placeholder="权限名称 ">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="power_url" id="user-phone" placeholder="权限路径 ">
            </div>
          </div>
...
$(document).ready(function(){
	...
	var options={
			url:"<%=basePath%>power/addPower.action",
			type:"post",
